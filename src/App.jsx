        ...
        <div className="footer-grid" style={{ maxWidth:1200, margin:"0 auto", display:"grid", gridTemplateColumns:"2fr 1fr 1fr 1fr 1fr", gap:28 }}>
          <div>
            <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:10 }}>
              ...
              <div>
                <div style={{ fontFamily:"'BrandFont', 'Noto Sans KR', sans-serif", fontSize:20, fontWeight:800 }}><span style={{ color:C.cream }}>Q</span> <span style={{ color:C.tealLight }}>인사이드</span><span style={{ color:C.gold, marginLeft:5, fontSize:11, fontWeight:600, fontFamily:"'Noto Sans KR',sans-serif", letterSpacing:"0.5px", verticalAlign:"top" }}>labs</span></div>
                <div style={{ fontSize:9, color:"rgba(244,241,235,0.45)", letterSpacing:"1.5px", fontFamily:"'Noto Sans KR', sans-serif" }}>Q Inside Labs</div>
