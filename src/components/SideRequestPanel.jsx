          ...
          <div style={{ padding:"24px 32px 32px" }}>
            <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:14, marginBottom:14 }}>
              ...
              <div>
                ...
                <input value={form.company} onChange={F("company")} placeholder="(주)뷰인사이드" style={{ width:"100%", padding:"10px 12px", borderRadius:6, border:"2px solid rgba(10,22,40,0.1)", fontSize:13, fontFamily:"inherit", outline:"none", boxSizing:"border-box" }} />
              </div>
            </div>
            <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:14, marginBottom:14 }}>
              <div>
