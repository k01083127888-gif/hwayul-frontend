...
권유 시 포함할 내용:
1. "WIHAM 인사이드 심층 상담(22만원, 3단계 패키지)"
...
"WIHAM 인사이드 심층 상담(22만원, 3단계 패키지)"을 통해 법적 리스크를 사전 차단할 수 있음을 자연스럽게 안내.`,
...
- "해당 가능성 낮음" → 다른 노동법 이슈(부당대우, 임금체불 등) 가능성 안내`,
  ...
  const systemPrompt = `당신은 'WIHAM 인사이드' 플랫폼의 ${topicLabel} 전문 AI 상담 도우미입니다.
