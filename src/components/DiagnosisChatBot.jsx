...
export function DiagnosisChatBot({ type = "checklist", resultData = null, setActive }) {
  ...
  const ROLE_CONFIG = {
    victim: {
      ...
      tone: "따뜻하고 공감하는 어조. '~이에요/~하셨겠어요' 공감체 사용. 첫 응답은 반드시 공감 표현으로 시작. '당신 잘못이 아닙니다'를 적절한 지점에서 전달",
    },
    accused: {
      label: "피지목인",
      icon: "😰",
      welcomeMsg: "어려운 상황에서 찾아주셨군요.\n\n괴롭힘 지목을 받으셨다면 불안하고 억울한 마음이 크실 겁니다. 이 상담은 판단하지 않습니다. 당신도 적정 절차를 받을 권리가 있습니다.\n\n조사 과정, 소명 기회, 대응 방법 등을 안내해 드리겠습니다.\n\n🔒 익명성이 보장됩니다 · 일반적 안내이며 법적 효력은 없습니다.\n⚠️ 본 대화 내용은 분쟁 과정에서 증거로 사용될 수 있으니 작성에 신중을 기해주세요.",
    ...
    sanjae: {
      ...
      tone: "실무적이면서 따뜻한 어조. '~이에요/~하셨겠어요' 공감체 사용. 산재보험법과 판례를 기반으로 안내하되 승인 가능성을 단정하지 않음",
    },
    company: {
      label: "회사 담당자",
      icon: "🏛️",
...
"화율인사이드 심층 상담(22만원, 3단계 패키지)"을 통해 법적 리스크를 사전 차단할 수 있음을 자연스럽게 안내.`,
...
[공감 원칙 — 피해자·산재·피지목인 상담 시]
- 첫 응답은 반드시 사용자의 상황에 대한 공감 표현으로 시작
- "많이 힘드셨겠어요", "여기까지 찾아오시기 쉽지 않으셨을 텐데" 같은 문장
- 사용자가 증거를 모았거나 적극적 행동을 했다면 "정말 잘 하고 계세요"로 격려
- 적절한 지점에서 "당신 잘못이 아닙니다" 메시지 전달 (피해자·산재 한정)
