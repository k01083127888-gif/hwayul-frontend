    ...
    <div onClick={() => handleTab("home")} style={{ display:"flex", alignItems:"center", gap:12, cursor:"pointer" }}>
      ...
      <div>
        <div style={{ fontFamily:"'BrandFont', 'Noto Sans KR', sans-serif", fontSize:18, fontWeight:800, letterSpacing:"-0.3px", lineHeight:1.2 }}>
          <span className="wiham" style={{ color:C.cream }}>WIHAM</span><span className="wiham-ko" style={{ color:C.gold, fontSize:"0.55em", fontWeight:700, marginLeft:3 }}>위함</span><span className="wiham-ko" style={{ color:C.tealLight, marginLeft:6 }}>인사이드</span>
        </div>
