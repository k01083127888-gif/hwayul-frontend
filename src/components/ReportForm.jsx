      ...
      <div style={{ display:"flex", flexDirection:"column", gap:14, marginBottom:18 }}>
        ...
        <div className="form-grid-2" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:14 }}>
          ...
          {form.userType === "corporate" ? (
            dark
              ? <DarkInput label="소속 기업/기관명" value={form.orgName} onChange={F("orgName")} placeholder="(주)WIHAM 인사이드" required />
              : <Input label="소속 기업/기관명" value={form.orgName} onChange={F("orgName")} placeholder="(주)WIHAM 인사이드" required />
          ) : (
            dark
