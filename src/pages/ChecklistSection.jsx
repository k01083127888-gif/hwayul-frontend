        ...
        {step === 4 && result && (
          <div>
            ...
            <div style={{ display:"flex", gap:12 }}>
              ...
              <button onClick={() => setActive("relief")} style={{ flex:2, padding:"13px", background:C.gold, border:"none", borderRadius:8, color:C.navy, fontWeight:800, fontSize:14, cursor:"pointer", fontFamily:"inherit" }}>🛡️ 피해자 구제 신청 →</button>
            </div>
          </div>
        )}
      </div>
